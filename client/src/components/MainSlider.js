...
function MainSlider() {
  ...
  return (
    ...
    <Slider className="slider-active" {...settings}>
              ...
              <div className="col-xl-5 col-lg-7 col-md-10">
                <div className="slider-content">
                  <div className="slider-title">
                    <h2 className="title" data-animation="fadeInUpBig" data-delay=".2s" data-duration="1.2s">Roger's Rescue</h2>
                  </div>
                  <div className="slider-desc">
                    <p className="desc" data-animation="fadeInUpBig" data-delay=".4s" data-duration="1.2s">Dogs have a way of bringing out the best in us, from their unwavering loyalty to their infectious joy for life. They truly have the power to make us better humans.</p>
                  </div>
      ...
      <div>
        <div className="single-slider slider-bg d-flex align-items-center" style = {{backgroundImage:{slider_bg01}}}>
          <div className="container custom-container">
            <div className="row">
              <div className="col-xl-5 col-lg-7 col-md-10">
                <div className="slider-content">
